...
const ProductDetail = () => {
  ...
  const relatedProducts = [
    { id: 2, name: 'Wireless Earbuds', price: 59.99, category: 'electronics', image: 'https://via.placeholder.com/300x300?text=Earbuds' },
    { id: 3, name: 'Headphone Stand', price: 24.99, category: 'accessories', image: 'https://via.placeholder.com/300x300?text=Stand' },
    { id: 4, name: 'Audio Cable', price: 12.99, category: 'accessories', image: 'https://via.placeholder.com/300x300?text=Cable' },
    { id: 5, name: 'Carrying Case', price: 19.99, category: 'accessories', image: 'https://via.placeholder.com/300x300?text=Case' }
  ];
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
        ...
        <div>
          ...
          <div className="mb-6">
            ...
            <span className="ml-2 bg-red-100 text-red-600 px-2 py-1 rounded text-sm">18% OFF</span>
          </div>
